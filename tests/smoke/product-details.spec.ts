...
test.describe('M4 — Product Details', () => {
  test('M4-01: navigating to /products/{slug} shows product details', async ({ page }) => {
  ...
  test('M4-02: detail page displays full description, category, and price', async ({ page }) => {
    await page.goto(`/products/${sampleProduct.slug}`);
  ...
  test('M4-03: add to cart from detail page updates cart badge', async ({ page }) => {
    await page.goto(`/products/${sampleProduct.slug}`);
  ...
  test('M4-04: clicking product in catalogue navigates to detail page', async ({ page }) => {
  ...
  test('M4-05: unknown slug shows product-not-found state', async ({ page }) => {
  ...
  test('M4-06: back to products link returns to catalogue', async ({ page }) => {
    await page.goto(`/products/${sampleProduct.slug}`);
